...
jsPsych.plugins['production-test-singlepic'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
	  ...
	  //trial.testType = trial.testType || "prod-singlepic";
	  trial.label = trial.label || "kita";
	  trial.question = trial.question || "What is the name of the alien?";
	  trial.question2 = trial.question2 || "Type the name for the alien in the text box.";
	  ...
	  trial.feedback = trial.feedback || "You entered an invalid response. Please enter your best guess for the alien's name."
